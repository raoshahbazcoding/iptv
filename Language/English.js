const English = {
  ...
  device_section: {
    Title: "DEVICES",
    heading: "Stream Anywhere - Enjoy Your Favorites on ",
    highlighted_text: "Any Device!",
    description:
      "Watch your favorite content anywhere with seamless support for Smart TVs, mobile devices, desktop browsers, and set-top boxes.",
    TV: "TV",
    Mobiles: "Mobiles",
    Laptop: "Laptop",
    Desktop: "Desktop",
  ...
  NonStop_Entertainment_section: {
    heading: "Non-stop Entertainment at an ",
    highlighted_text: "Unbeatable Price!",
    pricing_description: "Start Entertainment Now For Just",
    pricing: "$9.99 per month",
    pricing_description_othertext: "enjoy:",
    option: {
      first_option: "Live Sports with your favourite teams in action",
      second_option: "Top-rated TV shows and trending series",
      third_option: "Movies, Documentaries and much more all in one place!",
    },
    button_text: "Get in Now",
  },
  pricing_section: {
