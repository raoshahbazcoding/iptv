        ...
        <div className="relative w-full h-auto min-h-[677px] flex flex-col justify-center p-4 items-center mt-20 px-10" ref={divRef}>
            ...
            >
                ...
                <div className="flex flex-col items-center lg:items-start w-full lg:w-[50%] text-center lg:text-left">
                    <motion.h1
                        className="text-[#30a079]/10 text-[50px] lg:text-[70px] font-bold uppercase Features_label"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        ...
                        >
                            <div className="relative bg-[#292929] rounded-[10px] border border-white/10 p-6 flex flex-col items-start text-white py-10 gap-1 cursor-pointer transition-all duration-300 hover:scale-105">
                                <Image
                                    src="./mission.png"
                                    alt="Our Mission"
                                    width={0}
